...
public class ChessGameFrame extends JFrame {
    ...
    public ChessGameFrame(int width, int height) {
        setTitle("2022 CS109 Project by 韩汶霖 and 马骏烨"); //设置标题
        this.WIDTH = width;
        this.HEIGHT = height;
    ...
    private void addLoadButton(JPanel panel) {
        ImageIcon imageIcon = new ImageIcon("./image/load game image.png");
...
//            String path = JOptionPane.showInputDialog(this, "Input load path here");
    ...
    private void addStoreButton(JPanel panel) {
        ImageIcon imageIcon = new ImageIcon("./image/da01d7380f6bb5b2eafc08a354a77339.png");
