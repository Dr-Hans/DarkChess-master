...
public class Chessboard extends JComponent {
    ...
    private void initAdvisorOnBoard(int row, int col, ChessColor color) {
    ...
    private void initCannonOnBoard(int row, int col, ChessColor color) {
    ...
    private void initChariotOnBoard(int row, int col, ChessColor color) {
    ...
    private void initGeneralOnBoard(int row, int col, ChessColor color) {
    ...
    private void initHorseOnBoard(int row, int col, ChessColor color) {
    ...
    private void initMinisterOnBoard(int row, int col, ChessColor color) {
    ...
    private void initSoldierOnBoard(int row, int col, ChessColor color) {
     ...
     * @param chessData
     */
    public boolean loadGameAndRun(List<String> chessData) {
